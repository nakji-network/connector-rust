...
mod tests {
    ...
    fn test_build_topic_proto_messages() {
        ...
        let tpm = TopicProtoMsg {
            ...
            proto_message_name: "nakji.evm.chain.Block".to_string(),
            descriptor: vec![],
        };
        expected.push(tpm);
    ...
    fn test_generate_descriptor_file() {
        ...
        let tpm2 = TopicProtoMsg {
            ...
            proto_message_name: "nakji.evm.chain.Transaction".to_string(),
            descriptor: vec![],
        };
